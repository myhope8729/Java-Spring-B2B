...
$(document).ready(function(){
	...
	CommonGrid.init('gridContent', {
		datatype:"local",
		colModel:[
		      {label:'c1', 		name:'c1',		hidden:false,		align:'left',		sortable:false,		width:80,
		    	  formatter:function(cellvalue, options, rowObject)
		    	  {
		    		  return "<input name='c1' type='text' value='" + (cellvalue==undefined?'':cellvalue) + "' class='form-control'>";
		    	  }
		      },
		      {label:'c2', 		name:'c2',		hidden:false,		align:'left',		sortable:false,		width:80,
		    	  formatter:function(cellvalue, options, rowObject)
		    	  {
		    		  return "<input name='c2' type='text' value='" + (cellvalue==undefined?'':cellvalue) + "' class='form-control'>";
		    	  }
		      },
		      {label:'c3', 		name:'c3',		hidden:false,		align:'left',		sortable:false,		width:80,
		    	  formatter:function(cellvalue, options, rowObject)
		    	  {
		    		  return "<input name='c3' type='text' value='" + (cellvalue==undefined?'':cellvalue) + "' class='form-control'>";
		    	  }
		      },
		      {label:'c4', 		name:'c4',		hidden:false,		align:'left',		sortable:false,		width:80,
		    	  formatter:function(cellvalue, options, rowObject)
		    	  {
		    		  return "<input name='c4' type='text' value='" + (cellvalue==undefined?'':cellvalue) + "' class='form-control'>";
		    	  }
		      },
		      {label:'c5', 		name:'c5',		hidden:false,		align:'left',		sortable:false,		width:80,
		    	  formatter:function(cellvalue, options, rowObject)
		    	  {
		    		  return "<input name='c5' type='text' value='" + (cellvalue==undefined?'':cellvalue) + "' class='form-control'>";
		    	  }
		      },
...
function resetColProps(data)
{
	...
	if (codeId == 'BD0013') 
	{
		...
		contGrid.setColProp("c2", { formatter: function(cellvalue, options, rowObject) {
			...
			var html = "<select class='custList form-control' name='c2' seqNo='" + seqNo + "' >";
		...
		contGrid.setColProp("c3", { formatter: function(cellvalue, options, rowObject) {
			var seqNo = rowObject.seqNo || '';
			var html = "<select class='ppList form-control' name='c3' seqNo='" + seqNo + "'>";
			html += "<option  value=''>" + emptyLabel + "</option>";
