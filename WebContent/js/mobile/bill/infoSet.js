	$("#addPictureRow").click(function(){
		...
		$(".item_content .panel-body").append('<div class="image_row well fade" id="line_' + currentLineNo + '"><button type="button" data-mini="true" data-theme="b"  data-icon="delete" data-iconpos="notext" class="close" data-dismiss="alert"></button></div>');
		for (i=0; i<4; i++){
	...
	$("#textSave").click(function(){
		if ($("#addState").val() == "add"){
			...
			var template = '<div class="text_row well fade in" id="line_' + currentLineNo + '">\
				<button type="button" data-mini="true" data-theme="b"  data-icon="edit" data-iconpos="notext" class="editText ui-btn ui-btn-b ui-icon-edit ui-btn-icon-notext ui-shadow ui-corner-all ui-mini"></button>\
				<button type="button" data-mini="true" data-theme="b"  data-icon="delete" data-iconpos="notext" class="close ui-btn ui-btn-b ui-icon-delete ui-btn-icon-notext ui-shadow ui-corner-all ui-mini" data-dismiss="alert"></button>\
				<div class="text_content">' + textData + 
				'</div>\
				<label>\
				<input type="checkbox" name="showMark[' + currentLineNo + ']" id="showMark' + currentLineNo + '" />显示文字\
				</label>\
				</div>';
