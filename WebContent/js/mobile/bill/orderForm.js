...
function initItemGrid()
{
	...
	itemGridData.colModel.push( {name: "itemImgPath", sortable:false, align: "center", formatter: funcImg} );
...
function initCartGrid()
{
	...
	if (itemJsCol != '') {
		cartGridData.colModel.push( {name: "js_display", index: "js_display", align : "center", sortable:false, formatter: function(cellvalue, options, rowObj){
			return cellvalue;
		}} );
		cartGridData.colModel.push( {name: "js_qty", hidden: true} );
	}
	cartGridData.colModel.push( {name: "total_amt", index: "total_amt", align : "right", 	sortable: false} );
	cartGridData.colModel.push( {name: "item_note", index: "item_note", editable:true,		sortable: false} );
	cartGridData.colModel.push( {name: "state", index: "state", sortable:false,	align: "center", formatter: controlFunc} );
