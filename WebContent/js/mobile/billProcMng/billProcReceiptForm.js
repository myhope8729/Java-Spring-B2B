...
itemGridData.colModel.push({name:'qtyUnion', align:'right', width:80});
if (billProc.qtyYn == 'Y'){
...
itemGridData.colModel.push({name:'note', editable:true, width:100});
...
CommonGrid.init('gridProc', {
    ...
    postData: $('#billProcReceiptForm').serializeJSON(),
    colModel:[
