...
<div class="admin_body">
	...
	<form class="form-inline admin-form" id="billProcOrderForm" name="billProcOrderForm" role="form" action="<%= BaseController.getCmdUrl("BillProc", "saveBillProc") %>" method="POST">
		...
		<div class="action_bar row">
			<div class="col-sm-6 col-xs-12">
				...
				<c:if test="${not empty procEnv}">
					<qc:htmlSelect items="${procEnv}" itemValue="seqNo" itemLabel="c1"
						isEmpty="true" emptyLabel='sc.please.select.s' cssClass="form-control mgl20" id="procEnv" name="procEnv" />
				</c:if>
			...
			<div class="col-sm-6 col-xs-12 text-right">
				...
				<c:if test="${checkProcYn eq 'Y'}">
					<button type="button" class="btn btn-primary mgl10"><qc:message code="system.common.btn.zero" /></button>
				</c:if>
