...
<div id="content-body">
	<form class="form-horizontal admin-form" id="workFlowGroupEmpForm" name="workFlowGroupEmpForm" role="form" action="<%= BaseController.getCmdUrl("WorkFlow", "saveWorkFlowGroupEmp") %>" method="POST">
