				...
				<div class="row-fluid">
					<div class="form_field col-md-5 col-sm-6 col-xs-12 col-md-offset-1">
						...
						<div class="form-group">
							...
							<div class="col-md-9 col-sm-8 col-xs-6">
								<input type="password" name="pwd" id="pwd" class="input" style="ime-mode:inactive" validate="required: true,minlength:6" message="密码" value="${user.pwd}" maxlength="16" tabindex="3" size="20" placeholder="不能少于六位"/>
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-3 col-sm-4 col-xs-6"><label class="control-label"><span class="required">*</span>业务类别</label></div>
							<div class="col-md-9 col-sm-8 col-xs-6">
								<qc:codeList var="userTypes" codeGroup="UK0000" exceptCode="UK0004"/>
								<select id="userKind" name="userKind" tabindex="5" validate="required: true" message="业务类别">
						...
						<div class="form-group">
							...
							<div class="col-md-9 col-sm-8 col-xs-6">
								<input type="text" name="telNo" id="telNo" class="input" style="ime-mode:inactive" validate="required: true, digits:true" message="联系电话" value="${user.telNo }" maxlength="16" tabindex="7" size="20"/>
							</div>
						</div>
						<div class="form-group">
					...
					<div class="form_field col-md-5 col-sm-6 col-xs-12 ">
						...
						<div class="form-group">
							...
							<div class="col-md-9 col-sm-8 col-xs-6">
								<input type="text" name="contactName" id="contactName" class="input" style="ime-mode:inactive" validate="required: true" message="联系人" value="${user.contactName }" maxlength="16" tabindex="6" size="20"/>
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-3 col-sm-4 col-xs-6"><label class="control-label">手机号码</label></div>
							<div class="col-md-9 col-sm-8 col-xs-6">
								<input type="text" name="mobileNo" id="mobileNo" class="input" style="ime-mode:inactive" validate="" message="手机号码" value="${user.mobileNo}" maxlength="16" tabindex="8" size="20"/>
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-3 col-sm-4 col-xs-6"><label class="control-label"><span class="required">*</span>地址</label></div>
							<div class="col-md-9 col-sm-8 col-xs-6">
								<input type="text" name="userAddr" class="input" style="ime-mode:inactive" validate="required: true" message="地址" value="${user.userAddr }" maxlength="16" tabindex="12" size="20"/>
							</div>
						</div>
					</div>
				</div>
