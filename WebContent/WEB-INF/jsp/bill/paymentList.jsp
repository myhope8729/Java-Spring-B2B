...
<div class="admin_body">
	...
	<div class="row">
		<form id="paymentListFrm" class="searchForm">
			...
			<div class="col-lg-4 col-md-6 col-xs-12">
				<div class="row">
					...
					<div class="form-group col-sm-6 col-xs-12">
						<label class="control-label">订货方</label>
			...
			<div class="col-md-4 col-lg-offset-0 col-md-offset-8 col-sm-offset-6 col-sm-6 col-xs-12">
				<div class="row">
					<div class="form-group col-xs-12 col-lg-mgt20">
						...
						<a class="btn btn-primary pull-right" href="<%= BaseController.getCmdUrl("Payment", "paymentForm") %>"><qc:message code="system.common.btn.new"/></a>
					</div>
				</div>	
			</div>
		</form>
	...
	<div class="clear">
		<table id="grid" ajaxUrl="<%= BaseController.getCmdUrl("Payment", "paymentGridAjax") %>" searchForm="#paymentListFrm"></table>
