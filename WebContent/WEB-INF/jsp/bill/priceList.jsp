...
<div class="admin_body">
	...
	<div class="row">
		<form id="priceListFrm" class="searchForm">
				...
				<div class="row">
					<div class="form-group col-xs-12 col-lg-mgt20">
						...
						<a class="btn btn-primary pull-right" 
							<c:if test="${receiptMark == 'Y' }">href="<%= BaseController.getCmdUrl("Price", "billList") %>"</c:if>
							<c:if test="${receiptMark == 'N' }">href="<%= BaseController.getCmdUrl("Price", "priceDirectForm") %>"</c:if>
						><qc:message code="system.common.btn.new"/></a>
					</div>
				</div>	
			</div>
		</form>
	...
	<div class="clear">
		<table id="grid" ajaxUrl="<%= BaseController.getCmdUrl("Price", "priceGridAjax") %>" searchForm="#priceListFrm"></table>
