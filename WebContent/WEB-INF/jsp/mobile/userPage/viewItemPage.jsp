...
<div data-role="header" data-theme="b" >
   ...
   <a data-theme="b" data-role="button" data-icon="back" data-inline="true" class="ui-btn-right" data-iconpos="left" href="javascript:window.close();"> 
...
<div role="main" class="ui-content mgt10">
	...
	<div class="item_detail" style="width: 100%;">
		...
		<div class="item_block">
			<dl class="dl-horizontal item_properties">
		<% 
	...
	<% if (!StringUtils.isEmpty(priceField) && !StringUtils.isEmpty(userItem.get(priceField))){ %>
				<blockquote style="padding-right: 0px;">
					<div class="row">
						...
						<div class="col-xs-6 alignR no-padding" id="cartWrap">
