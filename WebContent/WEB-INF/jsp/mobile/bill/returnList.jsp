...
<div role="main" class="ui-content">
	<form id="returnListFrm" class="searchForm">
		<div class="search_collapse" data-mini="true" data-role="collapsible" data-theme="b" data-content-theme="a" data-collapsed="true" data-collapsed-icon="carat-d" data-expanded-icon="carat-u">
			...
			<div class="action-bar row">
				...
				<div class="text-left col-xs-12">	
					<label for="arriveDateFrom">单据日期</label>
				...
				<div class="text-left col-xs-12">
					<label for="vendorName">对方单位</label>
			 		<input type="text" name="hostCustName" value="${sc.hostCustName}" class="form-control mgl10" />
				</div>
			</div>	
	...
	<div class="clear">
		<table id="grid" ajaxUrl="<%= BaseController.getCmdUrl("Return", "returnGridAjax") %>" searchForm="#returnListFrm"></table>
