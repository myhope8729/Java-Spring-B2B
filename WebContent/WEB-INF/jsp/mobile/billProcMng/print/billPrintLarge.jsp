...
<div class="admin_body">
	<form id="billProcPrintForm" name="billProcPrintForm" onsubmit="reloadGrid();return false;" class="form-horizontal form-inline"> 
		<table class="table table-nobordered dataTable01">
			<colgroup>
				<col width="50%" />
				<col width="50%" />
	 		</colgroup>
			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align:right">
						...
						<c:choose>
							<c:when test="${empty billInfo.clerkno2}">
								${billInfo.hostTelNo} / ${billInfo.hostFaxNo}
							</c:when>
							<c:otherwise>
								${billInfo.clerkName}
							</c:otherwise>
				...
				<tr>
					<td></td>
					<td style="text-align:right"><font face="宋体" size="3" style="font-weight: normal;">白联存根  黄联对账  红联客户</font></td>
				</tr>
			</tbody>
		</table>
	</form>
